...
func (n *netConn) writeString(framer Framer, formatter Formatter, p Priority, hostname, app, tag, msg string) error {
	if framer == nil {
	...
	formattedMessage := framer(formatter(p, hostname, app, tag, msg))
